...
public enum ConfigMessage {
    ...
    ADMIN_UPDATE_AVAILABLE("&rThere is an update available: " + "https://modrinth.com/plugin/evenmorefish/versions?l=paper", PrefixType.ADMIN, false, false, "admin.update-available"),
