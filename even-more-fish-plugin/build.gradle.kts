...
dependencies {
    ...
    mirrorAwareLibs(libs.friendlyid)
    mirrorAwareLibs(libs.flyway.core)
    mirrorAwareLibs(libs.flyway.mysql)
    mirrorAwareLibs(libs.hikaricp)
    mirrorAwareLibs(libs.caffeine)
    mirrorAwareLibs(libs.commons.lang3)
    mirrorAwareLibs(libs.commons.codec)
    mirrorAwareLibs(libs.json.simple)
    mirrorAwareLibs(libs.jooq)
    mirrorAwareLibs(libs.jooq.codegen)
    mirrorAwareLibs(libs.jooq.meta)
    mirrorAwareLibs(libs.connectors.h2)
    mirrorAwareLibs(libs.maven.artifact)
    mirrorAwareLibs(libs.annotations)
    mirrorAwareLibs(libs.guava)
